...
Данная [утилита](https://ru.wikipedia.org/wiki/%D0%A3%D1%82%D0%B8%D0%BB%D0%B8%D1%82%D0%B0) создана для анализа [access.log](https://ru.wikipedia.org/wiki/Access.log). При реализации были использованы только стандартные бибилиотеки.


Основная задача утилиты:
